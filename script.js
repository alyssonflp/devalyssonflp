...
function openEdu() {
    ...
    const data = `<strong>[EDUCAÇÃO]</strong><br>FACULDADE ESTÁCIO - ADS<br>MICROCAMP - Informática Avançada<br><br><strong>[QUALIFICAÇÕES]</strong><br>UI/UX Design, Photoshop, IA & IoT.`;
