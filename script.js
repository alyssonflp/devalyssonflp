...
function openBio() {
    ...
    content.innerHTML = `
        <div style="text-align:center">
            ...
            <p id="ads-target" style="color:var(--accent); font-weight:bold; font-size:14px;"></p>
            <div id="bio-typing" style="text-align:left; opacity:0.9;"></div>
            <span class="cursor"></span>
        </div>
    `;
    const adsText = "> ADS | UI/UX Designer | IoT & IA";
    const bioText = "Apaixonado por tecnologia e design, transito entre o código e a experiência do usuário. Atualmente cursando ADS, aplico IA e IoT para criar sistemas inteligentes e interfaces que conectam.";
...
function openEdu() {
    ...
    content.innerHTML = `
        <div><strong style="color:var(--accent)">alyssonfelipe@root:~$</strong> <span id="edu-cmd"></span></div>
        <div id="edu-res" style="margin-top:15px;"></div>
        <span class="cursor"></span>
    `;
    const data = `<strong>[ EDUCAÇÃO ]</strong><br><br>
• <strong>FACULDADE ESTÁCIO</strong><br>
  Tecnólogo em ADS (Cursando) | Previsão: 2027<br><br>
...
- <strong>Design & Web:</strong> Photoshop & WordPress<br>
- <strong>Sistemas:</strong> IoT, IA & Hardware`;

    typeTerminal(document.getElementById('edu-cmd'), "cat education.sh", 50, () => {
        setTimeout(() => typeTerminal(document.getElementById('edu-res'), data, 5), 200);
    });
}
...
function openExp() {
    ...
    content.innerHTML = `
        <div><strong style="color:var(--accent)">alyssonfelipe@root:~$</strong> <span id="exp-cmd"></span></div>
        <div id="exp-res" style="margin-top:15px;"></div>
        <span class="cursor"></span>
    `;
    const data = `<strong>[ EXPERIÊNCIAS PROFISSIONAIS ]</strong><br><br>
• <strong>ALUARTS ESQUADRIAS</strong> – Pinhais, PR<br>
  <strong>Aux. Administrativo & Marketing Digital</strong> | 2020 – 2024<br><br>
• <strong>MUNDIAL MARCAS</strong> – Curitiba, PR<br>
  <strong>Web Designer</strong> | 2015 – 2017<br><br>
• <strong>OMAR CALÇADOS</strong> – Curitiba, PR<br>
  <strong>Consultor de Vendas</strong> | 2013 – 2014`;

    typeTerminal(document.getElementById('exp-cmd'), "cat experiences.sh", 50, () => {
        setTimeout(() => typeTerminal(document.getElementById('exp-res'), data, 5), 200);
    });
}
...
function openProject() {
    ...
    typeTerminal(document.getElementById('proj-cmd'), "./list_projects.sh", 50, () => {
        setTimeout(() => typeTerminal(document.getElementById('proj-res'), text, 20), 200);
    });
}
